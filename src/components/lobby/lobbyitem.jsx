...
export default function LobbyItem({roomDetails}) {
  ...
  return (
    <Card className={classes.root} style={{border: "solid black 1px"}}>
      <CardHeader
        avatar={
          <div>
      ...
      <CardActions disableSpacing>
        ...
        <Button variant="contained" style={{ color: "white", backgroundColor: "blue" }} onClick={handleClickOpenStage}>Enter Stage</Button>
